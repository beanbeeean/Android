...
public class MainActivity extends AppCompatActivity {
    ...
    private void addEventListener() {
        ...
        addButton.setOnClickListener(view -> {
            ...
            if(didRun){
                Toast.makeText(this, "초기화 후에 시도해주세요",
                        Toast.LENGTH_SHORT).show();
                return;
            }
            if(pickerNumberSet.size() >= 5){
                Toast.makeText(this, "번호는 5개까지만 선택 가능합니다",
                        Toast.LENGTH_SHORT).show();
                return;
            }
...
//            }
        ...
        runButton.setOnClickListener(view -> {
            ...
            if(didRun == true){
                Toast.makeText(this, "초기화 후에 시도 해주세요.",
                        Toast.LENGTH_SHORT).show();
                return;
            }
