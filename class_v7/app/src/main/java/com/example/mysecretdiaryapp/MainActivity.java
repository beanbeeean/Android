...
public class MainActivity extends AppCompatActivity {
    ...
    private void addEventListener() {
        ...
        openButton.setOnClickListener(v -> {
            ...
            String savePwd = passwordPreferences.getString("password", "000");
            ...
            if (savePwd.equals(passwordFormUser)) {
        ...
        changePasswordButton.setOnClickListener(v -> {
            ...
            if (changePasswordMode) {
                ...
                editor.putString("password", passwordFormUser); // 키의 Value값 변경
                // 완료 - 1. (apply : 비동기 방식)  2. (commit : UI를 멈추고 기다리는 방식)
                editor.apply();
